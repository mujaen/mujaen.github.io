...
_asyncToGenerator(function* () {
  ...
  var checkNavbarInactive = () => {
    ...
    return !((_document$activeEleme = document.activeElement) !== null && _document$activeEleme !== void 0 && _document$activeEleme.classList.contains('nav-btn'));
  };
  ...
  var notScrollIntoView$ = hashchange$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(document, 'scroll').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["debounceTime"])(50), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mapTo"])(true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(false))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(true)); // Certain events should make the navbar "jump" to a new position.
...
//# sourceMappingURL=navbar-hydejack-9.0.5.js.map