...
(function () {
  ...
  */
  ...
  function da(a, b, c, d) {
    ...
    if (b == a.length && d == c.length) {
      ...
      for (var l = c.length, k = 0; k < m - g && ea(a[--h], c[--l]);) {
        k++;
      }
    ...
    for (a = []; 0 < m || 0 < g;) {
      0 == m ? (a.push(2), g--) : 0 == g ? (a.push(3), m--) : (h = b[m - 1][g - 1], l = b[m - 1][g], k = b[m][g - 1], r = l < k ? l < h ? l : h : k < h ? k : h, r == h ? (h == d ? a.push(0) : (a.push(1), d = h), m--, g--) : r == l ? (a.push(3), m--, d = l) : (a.push(2), g--, d = k));
    }
  ...
  function Na(a, b) {
    ...
    for (var c = 0, d, e = void 0, f, g = void 0; c < b.length; c++) {
      if (d = b[c], f = La(d), f !== e && (g = a.indexOf(f), e = f), !x(f) || -1 < g) return d;
    }
  }
  ...
  */
      ...
      a: {
        ...
        switch (h.nodeType) {
          case Node.ELEMENT_NODE:
            ...
            for (var k = "<" + m, r = h.attributes, C = 0, R; R = r[C]; C++) {
              k += " " + R.name + '="' + R.value.replace(Qb, Sb) + '"';
            }
  ...
  var Xb = document.implementation.createHTMLDocument("inert"),
    ...
    set innerHTML(a) {
      if ("template" === this.localName) this.__shady_native_innerHTML = a;else {
        ...
        for (v.c ? b.__shady_native_innerHTML = a : b.innerHTML = a; a = b.__shady_firstChild;) {
  ...
  function Lb(a, b, c) {
    ...
    if (v.preferPerformance) for (; b = a.host.__shady_native_firstChild;) {
    ...
    if (this.a) {
      ...
      for (c = 0; c < b.length; c++) {
        ...
        for (f = f.__shady_firstChild; f; f = f.__shady_nextSibling) {
          if ("slot" == f.localName) for (var g = u(f).l, h = 0; h < g.length; h++) {
            d.push(g[h]);
          } else d.push(f);
        }
        ...
        for (var m = h = 0, l = void 0; h < g.length && (l = g[h]); h++) {
          for (var k = 0, r = void 0; k < l.s.length && (r = l.s[k]); k++) {
            r.__shady_native_parentNode === e && e.__shady_native_removeChild(r), f.splice(l.index + m, 1);
          }
        ...
        for (l = void 0; m < g.length && (l = g[m]); m++) {
          for (h = f[l.index], k = l.index; k < l.index + l.v; k++) {
            r = d[k], e.__shady_native_insertBefore(r, h), f.splice(k, 0, r);
          }
        }
      }
    }

    if (!v.preferPerformance && !this.H) for (b = this.host.__shady_firstChild; b; b = b.__shady_nextSibling) {
...
//# sourceMappingURL=LEGACY-vendors~shadydom-hydejack-9.0.5.js.map